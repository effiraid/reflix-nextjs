...
- **Data:** Static JSON in `src/data/` and `public/data/` — `src/data/index.json`, `categories.json`, `tag-groups.json`, `tag-i18n.json`, browse artifacts in `public/data/browse/{summary,projection}.json`, and clip detail JSON in `public/data/clips/{id}.json`. Generated by export pipeline, not hand-edited.
